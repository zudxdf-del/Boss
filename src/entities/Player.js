export class Player {
  constructor(){this.radius=16;this.speed=285;this.maxHp=100;this.maxShield=50;this.damage=30;this.fireRate=.11;this.reset(0,0,null);}
  reset(w,h,arena=null){this.x=arena?arena.cx-arena.radius*.55:w*.27;this.y=arena?arena.cy:h*.5;this.hp=this.maxHp;this.shield=this.maxShield;this.cooldown=0;}
